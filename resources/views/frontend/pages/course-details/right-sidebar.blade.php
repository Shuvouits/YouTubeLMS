        ...
        <div class="card card-item">
            <div class="card-body">
                ...
                <ul class="generic-list-item generic-list-item-flash">
                    ...
                    <li class="d-flex align-items-center justify-content-between"><span><i
                                class="la la-play-circle-o mr-2 text-color"></i>Lectures</span> 17
                    </li>
                    <li class="d-flex align-items-center justify-content-between"><span><i
                    ...
                    <li class="d-flex align-items-center justify-content-between"><span><i
                                class="la la-lightbulb mr-2 text-color"></i>Skill level</span> All
                        levels</li>
                    <li class="d-flex align-items-center justify-content-between"><span><i
                                class="la la-users mr-2 text-color"></i>Students</span> 30,506</li>
                    <li class="d-flex align-items-center justify-content-between"><span><i
                                class="la la-certificate mr-2 text-color"></i>Certificate</span> Yes
                    </li>
                </ul>
            </div>
        </div><!-- end card -->
        ...
        <div class="card card-item">
            <div class="card-body">
                ...
                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                    ...
                    <div class="media-body">
                        <h5 class="fs-15"><a href="course-details.html">Introduction LearnPress –
                                LMS plugin</a></h5>
                        <span class="d-block lh-18 py-1 fs-14">Kamran Ahmed</span>
